...
const I18N = {
  ...
  dic: {
    ...
    copa_eliminacion: { es: 'Eliminación directa · a un partido', pt: 'Eliminação direta · jogo único' },
    ...
    btn_resultado: { es: 'Resultado', pt: 'Resultado' },
    ...
    /* ------- Admin (React) ------- */
    admin_tab_equipos: { es: 'Equipos', pt: 'Equipes' },
    admin_tab_resultados: { es: 'Resultados', pt: 'Resultados' },
    admin_tab_competencias: { es: 'Competencias', pt: 'Competições' },
    admin_tab_config: { es: 'Configuración', pt: 'Configuração' },
    admin_equipos_lista: { es: '{n} equipos', pt: '{n} equipes' },
    admin_res_lista: { es: 'Partidos cargados', pt: 'Jogos carregados' },
    admin_round: { es: 'Fecha {n}', pt: 'Rodada {n}' },
    admin_ida_vuelta: { es: 'Ida y vuelta', pt: 'Ida e volta' },
    admin_eliminacion: { es: 'Eliminación directa', pt: 'Mata-mata' },
    admin_register_gate: { es: 'Solo cuentas locales pueden crear copas', pt: 'Apenas contas locais podem criar copas' },
    round_title: { es: 'Fecha {n}', pt: 'Rodada {n}' },
    copa_primera_ronda: { es: 'Primera ronda', pt: 'Primeira rodada' },
    label_equipos_short: { es: 'equipos', pt: 'equipes' },
    toast_ronda_generada: { es: 'Siguiente ronda generada ({n})', pt: 'Próxima rodada gerada ({n})' },
    comp_edit_lock_note: { es: 'Los equipos ya asignados no se pueden quitar.', pt: 'As equipes já atribuídas não podem ser removidas.' },
    comp_delete_summary: { es: '{teams} equipos · {matches} partidos', pt: '{teams} equipes · {matches} jogos' },
    admin_saved: { es: 'Guardado', pt: 'Salvo' },
    admin_save_error: { es: 'No se pudo guardar en la base de datos', pt: 'Não foi possível salvar no banco de dados' },
    admin_delete_team_q: { es: '¿Eliminar el equipo {name}?', pt: 'Excluir a equipe {name}?' },
    quiz_correct_prompt: { es: '¡Correcto!', pt: 'Correto!' },
    quiz_wrong_prompt: { es: 'Incorrecto', pt: 'Incorreto' },
    footer_line: { es: 'La casa de la Celeste en PSO', pt: 'A casa da Celeste no PSO' },
